...
contract SyndicateVault is ReentrancyGuard {
   ...
   event ProposalCreated(uint256 indexed proposalId, address tokenIn, address tokenOut, uint256 amountIn);
   ...
   function execute(uint256 proposalId) external nonReentrant {
       ...
       require(address(this).balance >= proposal.amountIn, "Insufficient balance");
       ...
       // Execute swap
       uint256 amountOut = swapRouter.exactInputSingle{value: proposal.amountIn}(params);
